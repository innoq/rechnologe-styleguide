...
<div class="navbar-layout">
  ...
  <main class="main-layout">
    ...
    <div class="button-group"><button class="button tertiary" type="submit">Alle ermahnen</button><button class="button primary" type="submit">Neue Rechnung</button></div>

    <div>
      <div><span class="muted">Gesamt:</span>
